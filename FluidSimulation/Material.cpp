...
void Shader::sendFloat(const char* name, float val){
    assignShader();
    unsigned int unifLocat = glGetUniformLocation(shaderProgram, name);
...
{
    this->assignShader();
    unsigned int projectionLocation = glGetUniformLocation(shaderProgram, "current_projection_matrix");
	
    unsigned int modelviewLocation = glGetUniformLocation(shaderProgram, "current_modelview_matrix");
...
{
    this->assignShader();
    unsigned int cameraLocation = glGetUniformLocation(shaderProgram, "camera_position");
...
{
        unsigned int unifLocation = glGetUniformLocation(shaderProgram, name);
